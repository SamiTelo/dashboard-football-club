  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      {/*---------------------------------------------------
       ...
       -------------------------------------------------------*/}
      <div className="order-1 md:order-2 hidden md:flex relative bg-[url('/assets/info.jpg')] bg-cover bg-center min-h-100 md:min-h-screen items-center justify-center">
        {/* Logo */}
