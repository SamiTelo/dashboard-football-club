...
export function PopUpdateUsers() {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md rounded-xl p-6">
        <DialogHeader className="space-y-2">
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            Modifier les informations de l&#39;utilisateur puis cliquez sur
            Modifier.
          </DialogDescription>
        </DialogHeader>
        ...
        <form className="space-y-4 mt-4">
          <FieldGroup>
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 ">
              <Field className="space-y-2">
                <Label>Nom</Label>
                <Input defaultValue="Devonne" />
              </Field>

              <Field className="space-y-2">
                <Label>Prénom</Label>
                <Input defaultValue="Wallbridge" />
              </Field>
            </div>
          ...
          <DialogFooter className="pt-6 flex gap-2">
            ...
            <Button className="bg-black hover:bg-green-400">Modifier</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
